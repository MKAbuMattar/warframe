...
import {
  GlyphResponseSample200,
  GlyphResponseSample400,
  GlyphResponseSample404,
  GlyphResponseSample500,
...
const Glyph = ({ icon }) => {
  return (
    <Fragment>
      <ResponseContainer>
        <ResponseBox>
          <SubTitle>{icon} Glyph</SubTitle>
          <CodeHighlight
            key={'1'}
            code={`GET https://warframe-info.netlify.app/api/v1/glyph`}
