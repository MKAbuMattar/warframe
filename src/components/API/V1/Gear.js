...
import {
  GearResponseSample200,
  GearResponseSample400,
  GearResponseSample404,
  GearResponseSample500,
...
const Gear = ({ icon }) => {
  return (
    <Fragment>
      <ResponseContainer>
        <ResponseBox>
          <SubTitle>{icon} Gear</SubTitle>
          <CodeHighlight
            key={'1'}
            code={`GET https://warframe-info.netlify.app/api/v1/gear`}
